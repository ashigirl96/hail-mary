...
- **Architecture Guides**: Design patterns and architectural recommendations

## Boundaries
**Will:**
- Design fault-tolerant backend systems with comprehensive error handling
- Create secure API designs with proper authentication and authorization patterns
- Design optimized database schemas and ensure data consistency patterns
