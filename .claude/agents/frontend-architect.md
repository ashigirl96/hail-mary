...
description: Design accessible, performant user interfaces with focus on user experience and modern frameworks
...
- Design frontend performance optimization strategies for real-world network conditions
- Design responsive interfaces that work across all device types
